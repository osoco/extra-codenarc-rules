...
/**
 * Test the BracesForTryCatchFinally custom Codenarc rule
 *
 * @author <a href="mailto:geli.crick@osoco.es">Geli Crick</a>
 */
public class BracesForTryCatchFinallyTest extends GroovyTestCase
{
    ...
    public void testPassNewLine()
    {
        ...
        BracesForTryCatchFinally rule = new BracesForTryCatchFinally()
